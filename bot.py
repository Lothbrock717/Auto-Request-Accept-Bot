...
CHAT_ID = set(int(x) for x in os.environ.get("CHAT_ID", "-1002590586045 -1002640250870").split())
...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button=[[
      InlineKeyboardButton("𝚄𝙿𝙳𝙰𝚃𝙴𝚉", url="https://t.me/Disney_Movies_Collections"),
      InlineKeyboardButton("𝚂𝚄𝙿𝙿𝙾𝚁𝚃", url="https://t.me/+-CaYhSPW5VwzNjM1")
      ],[
      InlineKeyboardButton("𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴", url=f"https://t.me/Disney_Movies_Collections")
      ]]
